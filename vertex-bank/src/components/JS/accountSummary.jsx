...
import { processingTransaction, AccountFacts } from '../../services/accountInfo.js';
            ...
            <div className="savingsContainer">
                ...
                <span>
                    <button type="button" onClick={()=>{
                                const success = processingTransaction("Transfer", 50);
                                if(success)
                                    alert("Funds moved!");
                            }}>Transfer</button>
                    ...
                    <button type="button" onClick={()=>{
                                const success = processingTransaction("Deposit", 50);
                                if(success)
                                    alert("Funds Deposited!");
                            }}>Deposit</button>

                    <button type="button" onClick={()=>  {
                            const success = processingTransaction("Withdraw", 50);
                                if(success)
